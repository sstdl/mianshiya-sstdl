...
/** getQuestionByPage POST /api/question/list/page */
export async function getQuestionByPageUsingPost(
...
/** listQuestionVOMyByPage POST /api/question/list/page/vo/my */
export async function listQuestionVoMyByPageUsingPost(
  body: API.QuestionQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePageQuestionVO_>(
    "/api/question/list/page/vo/my",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
